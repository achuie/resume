...
\begin{aSection}{Experience}
    ...
    \item Built and maintained developer tooling to enable designing and supporting many account projects
        ...
        \begin{subList}
            \item Developed live controller monitoring bot in Go, reducing response time from days to minutes
            \item Worked on system inspection webapp using ReactJS \& Python, accelerating pinpoint debugging
