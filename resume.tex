...
\begin{aSection}{Experience}
    ...
    \item Engineered controller system simulator, enabling company-wide \textbf{test-driven development}
        ...
        \item Emulated warehouse control systems (WCS/\textbf{PLC}) in \textbf{Python} for integration testing critical features
    ...
    \item Spearheaded, designed, and implemented \textbf{Pytest} framework to validate override- \& migration- operations
        on controller configurations, reducing downtime and debugging in on-site, production deployments
