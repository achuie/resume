...
\begin{aSection}{Experience}
    ...
    \item Architected \textbf{Pytest} framework to validate controller config migrations, cutting on-site downtime
    \item Developed live monitoring bot in \textbf{Go}, cutting response time across thousands of deployments
        \begin{subList}
