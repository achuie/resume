...
\begin{aSection}{Experience}
    \begin{expSubsection}
        ...
        {Koto, Tokyo, JP}
    \item Developed controller simulator and GitLab-based CI pipeline management system, the foundation for company-wide
        test driven development
        \begin{subList}
            \item Simulated QML UI interactions to automate validation for onsite operations
            \item Emulated warehouse control systems (WCS/PLC) in Python for integration testing critical features
            \item Designed and implemented state machines for testing complex gripper interactions and behaviors
            \item Wrote and maintained per-project test suites of feature tests, corner cases, and injected fault
                scenarios to provide guarantees for project deliverables
        \end{subList}
    \item Built and maintained developer tooling to enable designing and supporting many account projects
        simultaneously, quadrupling revenue opportunities
        \begin{subList}
            \item Developed system monitoring bot written in Go to keep track of live deployments, reducing response
                time from days to minutes
            \item Worked on system diagnostics and inspection webapp using ReactJS and Python, enabling quick and
                pinpoint debugging
            \item Orchestrated containerized web services with Kubernetes to scale with developer demand
...
\begin{aSection}{Technical Proficiency}
    \begin{tabularx}{\textwidth}{@{}>{\bfseries}l X@{}}
        Computer Languages & Python, Rust, Go, Bash,
            ...
            Java, JavaScript\\
        Development Tools & Pytest, GNU/Linux (Arch Linux \& Debian), Git, GitLab, Docker, Nix \& Nixpkgs, Kubernetes
    \end{tabularx}
\end{aSection}
...
\begin{aSection}{Education} \textbf{Rice University} \hfill \textit{Houston, TX, USA}\\
    ...
    Autamata, Formal Languages, and Computability; Computer Game Design; Tools
