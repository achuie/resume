...
\begin{aSection}{Experience}
    ...
    \item Engineered controller system simulator, enabling company-wide \textbf{test-driven development}
        ...
        \item Designed and programmed control routines emulating warehouse control systems (WCS/\textbf{PLC}) and
            complex hardware interactions in \textbf{Python} for integration testing critical features
    ...
    \item Evaluated and prototyped \textbf{Nix} for better reproducibility compared to JHBuild
    \end{expSubsection}
